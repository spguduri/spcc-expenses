...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", color: C.text }}>
      ...
      {/* Header */}
      <div style={{ background: "linear-gradient(135deg, #FFFFFF 0%, #384959 100%)", padding: "10px 16px", display: "flex", alignItems: "center", gap: 12, boxShadow: "0 4px 16px rgba(56,73,89,0.3)", borderRadius: "0 0 28px 28px" }}>
